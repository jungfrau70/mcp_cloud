...
class RAGService:
    ...
    def _create_enhanced_prompt_template(self):
        ...
        제공된 컨텍스트 정보를 바탕으로 사용자의 질문에 대해 전문적이고 실용적인 답변을 제공해주세요.
        
        답변 시 다음을 고려해주세요:
        1. 컨텍스트에 있는 정보를 우선적으로 활용
        2. 실제 운영 환경에서 적용 가능한 구체적인 가이드 제공
        3. 보안, 비용, 성능 관점에서의 권장사항 포함
        4. 컨텍스트에 없는 내용에 대해서는 솔직하게 답변 불가능함을 명시
