  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(user)) {
        ...
        _push(`<div><button class="text-gray-700 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-medium"> \uB85C\uADF8\uC778 </button></div>`);
      }
...
//# sourceMappingURL=default-XsboEWTH.mjs.map
