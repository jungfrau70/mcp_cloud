...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "p-4 sm:p-6 lg:p-8" }, _attrs))}><div class="max-w-4xl mx-auto"><h1 class="text-2xl font-bold text-gray-900 mb-2">\uB0B4 \uD504\uB85C\uD544</h1><p class="mb-6 text-sm text-gray-600">\uC0AC\uC6A9\uC790 \uC720\uD615: <span class="${ssrRenderClass([roleLabelClass.value, "font-semibold"])}">${ssrInterpolate(roleLabel.value)}</span></p><div class="bg-white shadow-md rounded-lg p-6"><div class="flex justify-between items-center mb-4"><h2 class="text-lg font-semibold text-gray-800">API \uD0A4 \uAD00\uB9AC</h2><button class="px-4 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"> + \uC0C8 \uD0A4 \uCD94\uAC00 </button></div>`);
      if (isLoading.value) {
...
//# sourceMappingURL=profile-B0zAfkEP.mjs.map
