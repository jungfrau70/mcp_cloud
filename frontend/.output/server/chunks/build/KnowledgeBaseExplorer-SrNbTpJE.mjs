...
import { ssrRenderClass, ssrInterpolate, ssrRenderComponent, ssrRenderList, ssrRenderAttr, ssrIncludeBooleanAttr, ssrLooseContain, ssrRenderAttrs, ssrLooseEqual, ssrRenderStyle } from 'vue/server-renderer';
...
function resolveApiBase() {
  ...
  return ((_a = config == null ? void 0 : config.public) == null ? void 0 : _a.apiBaseUrl) || "/api";
}
function useKbApi() {
  var _a;
...
const _sfc_main$5 = {
  ...
  emits: ["file-click", "file-open", "directory-create", "directory-rename", "directory-delete", "file-move", "file-upload"],
  setup(__props, { emit: __emit }) {
    ...
    const sortedTree = computed(() => {
      const dirs = { ...props.tree };
      delete dirs.files;
      return Object.keys(dirs).filter((key) => props.showHiddenFiles || !key.startsWith(".")).sort().reduce((acc, key) => {
        acc[key] = dirs[key];
        return acc;
      }, {});
    });
    ...
    watch(showDirectoryBrowser, (isOpen2) => {
      if (isOpen2) {
        loadDirectoryTree();
      }
    });
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({
        class: ["file-tree", { "upload-enabled": __props.enableUpload }]
      }, _attrs))} data-v-bceebdd8>`);
      if (__props.enableUpload && __props.depth === 0) {
        _push(`<div class="upload-area" data-v-bceebdd8><input type="file" multiple style="${ssrRenderStyle({ "display": "none" })}" accept="*/*" data-v-bceebdd8><button class="upload-button" title="\uD30C\uC77C \uC5C5\uB85C\uB4DC" data-v-bceebdd8> \u{1F4C1} \uD30C\uC77C \uC5C5\uB85C\uB4DC </button></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<ul data-v-bceebdd8><!--[-->`);
      ssrRenderList(sortedTree.value, (item, name) => {
        _push(`<li data-v-bceebdd8><div class="${ssrRenderClass(["tree-item", { "is-directory": isDirectory(item), "is-open": isOpen(name), "drag-over": dragOverTarget.value === name }])}" style="${ssrRenderStyle({ "padding-left": __props.depth * 15 + "px" })}"${ssrRenderAttr("draggable", isDirectory(item))} data-v-bceebdd8>`);
        if (isDirectory(item)) {
          _push(`<span class="icon" data-v-bceebdd8>${ssrInterpolate(isOpen(name) ? "\u25BC" : "\u25B6")}</span>`);
        } else {
          _push(`<span class="icon" data-v-bceebdd8>\u{1F4C4}</span>`);
        }
        _push(`<span class="${ssrRenderClass([{ "hidden-item": name.startsWith(".") }, "name"])}" data-v-bceebdd8>${ssrInterpolate(name)}</span>`);
        if (isDirectory(item)) {
          _push(`<div class="directory-actions" data-v-bceebdd8><button class="action-btn" title="\uC0C8 \uD56D\uBAA9 \uC0DD\uC131" data-v-bceebdd8>+</button></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
      ...
      ssrRenderList(files.value, (file) => {
        _push(`<li data-v-bceebdd8><div class="${ssrRenderClass(["tree-item", "is-file", { "is-selected": __props.selectedFile === (file.path || constructPath(file)) }])}"${ssrRenderAttr("data-path", file.path || constructPath(file))} style="${ssrRenderStyle({ "padding-left": __props.depth * 15 + "px" })}" draggable="true" data-v-bceebdd8><span class="icon" data-v-bceebdd8>\u{1F4C4}</span><span class="${ssrRenderClass([{ "hidden-item": (file.name || file).startsWith(".") }, "name"])}" data-v-bceebdd8>${ssrInterpolate(file.name || file)}</span></div></li>`);
      });
      _push(`<!--]--></ul>`);
      if (showDirectoryContextMenu.value) {
        _push(`<div style="${ssrRenderStyle({ left: contextMenuX.value + "px", top: contextMenuY.value + "px" })}" class="context-menu" data-v-bceebdd8><div class="context-menu-item" data-v-bceebdd8>\u{1F4C1} \uC0C8 \uB514\uB809\uD1A0\uB9AC</div><div class="context-menu-item" data-v-bceebdd8>\u{1F4C4} \uC0C8 \uD30C\uC77C</div><div class="context-menu-divider" data-v-bceebdd8></div><div class="context-menu-item" data-v-bceebdd8>\u270F\uFE0F \uC774\uB984 \uBCC0\uACBD</div><div class="context-menu-item text-red-600" data-v-bceebdd8>\u{1F5D1}\uFE0F \uC0AD\uC81C</div></div>`);
      } else {
        _push(`<!---->`);
      }
      if (showFileContextMenu.value) {
        _push(`<div style="${ssrRenderStyle({ left: contextMenuX.value + "px", top: contextMenuY.value + "px" })}" class="context-menu" data-v-bceebdd8>`);
        if (!isSelectedInTrash.value) {
          _push(`<div class="context-menu-item" data-v-bceebdd8>\u270F\uFE0F \uC774\uB984 \uBCC0\uACBD</div>`);
        } else {
          _push(`<!---->`);
        }
        if (!isSelectedInTrash.value) {
          _push(`<div class="context-menu-item text-red-600" data-v-bceebdd8>\u{1F5D1}\uFE0F \uC0AD\uC81C(\uD734\uC9C0\uD1B5\uC73C\uB85C)</div>`);
        } else {
          _push(`<!---->`);
        }
        if (isSelectedInTrash.value) {
          _push(`<div class="context-menu-item" data-v-bceebdd8>\u21A9\uFE0F \uBCF5\uAD6C</div>`);
        } else {
          _push(`<!---->`);
        }
        if (isSelectedInTrash.value) {
          _push(`<div class="context-menu-item text-red-600" data-v-bceebdd8>\u274C \uC601\uAD6C \uC0AD\uC81C</div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
      ...
      if (showCreateMenu.value) {
        _push(`<div style="${ssrRenderStyle({ left: contextMenuX.value + "px", top: contextMenuY.value + "px" })}" class="context-menu" data-v-bceebdd8><div class="context-menu-item" data-v-bceebdd8>\u{1F4C1} \uC0C8 \uB514\uB809\uD1A0\uB9AC</div><div class="context-menu-item" data-v-bceebdd8>\u{1F4C4} \uC0C8 \uD30C\uC77C</div></div>`);
      } else {
        _push(`<!---->`);
      }
      if (showRenameDialog.value) {
        _push(`<div class="modal-overlay" data-v-bceebdd8><div class="modal-content" data-v-bceebdd8><h3 class="modal-title" data-v-bceebdd8>\uC774\uB984 \uBCC0\uACBD</h3><input${ssrRenderAttr("value", newName.value)} class="modal-input" placeholder="\uC0C8 \uC774\uB984\uC744 \uC785\uB825\uD558\uC138\uC694" data-v-bceebdd8><div class="modal-actions" data-v-bceebdd8><button class="btn-primary" data-v-bceebdd8>\uD655\uC778</button><button class="btn-secondary" data-v-bceebdd8>\uCDE8\uC18C</button></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
      if (showCreateDialog.value) {
        _push(`<div class="modal-overlay" data-v-bceebdd8><div class="modal-content" data-v-bceebdd8><h3 class="modal-title" data-v-bceebdd8>${ssrInterpolate(createType.value === "directory" ? "\uC0C8 \uB514\uB809\uD1A0\uB9AC" : "\uC0C8 \uD30C\uC77C")}</h3><input${ssrRenderAttr("value", newName.value)} class="modal-input"${ssrRenderAttr("placeholder", createType.value === "directory" ? "\uB514\uB809\uD1A0\uB9AC \uC774\uB984" : "\uD30C\uC77C \uC774\uB984")} data-v-bceebdd8><div class="modal-actions" data-v-bceebdd8><button class="btn-primary" data-v-bceebdd8>\uC0DD\uC131</button><button class="btn-secondary" data-v-bceebdd8>\uCDE8\uC18C</button></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
      if (showUploadDialog.value) {
        _push(`<div class="modal-overlay" data-v-bceebdd8><div class="modal-content upload-dialog" data-v-bceebdd8><h3 class="modal-title" data-v-bceebdd8>\uD30C\uC77C \uC5C5\uB85C\uB4DC</h3><div class="upload-section" data-v-bceebdd8><label class="upload-label" data-v-bceebdd8>\uC5C5\uB85C\uB4DC \uACBD\uB85C:</label><div class="path-input-container" data-v-bceebdd8><input${ssrRenderAttr("value", uploadPath.value)} class="modal-input path-input" placeholder="\uC5C5\uB85C\uB4DC\uD560 \uB514\uB809\uD1A0\uB9AC \uACBD\uB85C" readonly data-v-bceebdd8><button type="button" class="browse-button" title="\uB514\uB809\uD1A0\uB9AC \uC120\uD0DD" data-v-bceebdd8> \u{1F4C1} </button></div></div><div class="upload-section" data-v-bceebdd8><label class="upload-label" data-v-bceebdd8>\uC120\uD0DD\uB41C \uD30C\uC77C (${ssrInterpolate(uploadFiles.value.length)}\uAC1C):</label><div class="file-list" data-v-bceebdd8><!--[-->`);
        ssrRenderList(uploadFiles.value, (file, index) => {
          _push(`<div class="file-item" data-v-bceebdd8><span class="file-name" data-v-bceebdd8>${ssrInterpolate(file.name)}</span><span class="file-size" data-v-bceebdd8>(${ssrInterpolate(formatFileSize(file.size))})</span></div>`);
        });
        _push(`<!--]--></div></div><div class="upload-section" data-v-bceebdd8><label class="checkbox-label" data-v-bceebdd8><input type="checkbox"${ssrIncludeBooleanAttr(Array.isArray(overwriteFiles.value) ? ssrLooseContain(overwriteFiles.value, null) : overwriteFiles.value) ? " checked" : ""} data-v-bceebdd8> \uAE30\uC874 \uD30C\uC77C \uB36E\uC5B4\uC4F0\uAE30 </label></div>`);
        if (isUploading.value) {
          _push(`<div class="upload-section" data-v-bceebdd8><div class="progress-bar" data-v-bceebdd8><div class="progress-fill" style="${ssrRenderStyle({ width: uploadProgress.value + "%" })}" data-v-bceebdd8></div></div><div class="progress-text" data-v-bceebdd8>${ssrInterpolate(uploadProgress.value)}% \uC5C5\uB85C\uB4DC \uC911...</div></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<div class="modal-actions" data-v-bceebdd8><button class="btn-primary"${ssrIncludeBooleanAttr(isUploading.value || uploadFiles.value.length === 0) ? " disabled" : ""} data-v-bceebdd8>${ssrInterpolate(isUploading.value ? "\uC5C5\uB85C\uB4DC \uC911..." : "\uC5C5\uB85C\uB4DC")}</button><button class="btn-secondary"${ssrIncludeBooleanAttr(isUploading.value) ? " disabled" : ""} data-v-bceebdd8>\uCDE8\uC18C</button></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
      if (showDirectoryBrowser.value) {
        _push(`<div class="modal-overlay" data-v-bceebdd8><div class="modal-content directory-browser" data-v-bceebdd8><h3 class="modal-title" data-v-bceebdd8>\uB514\uB809\uD1A0\uB9AC \uC120\uD0DD</h3><div class="directory-browser-content" data-v-bceebdd8><div class="current-path" data-v-bceebdd8><span class="path-label" data-v-bceebdd8>\uD604\uC7AC \uACBD\uB85C:</span><span class="path-value" data-v-bceebdd8>${ssrInterpolate(selectedDirectoryPath.value || "/")}</span></div><div class="directory-tree-container" data-v-bceebdd8>`);
        if (isLoadingDirectories.value) {
          _push(`<div class="loading-message" data-v-bceebdd8> \uB514\uB809\uD1A0\uB9AC \uB85C\uB529 \uC911... </div>`);
        } else {
          _push(`<div class="directory-tree" data-v-bceebdd8><div class="breadcrumb" data-v-bceebdd8>`);
          if (currentPath.value !== "") {
            _push(`<button class="breadcrumb-item breadcrumb-up" data-v-bceebdd8> \u2190 \uC0C1\uC704 \uD3F4\uB354 </button>`);
          } else {
            _push(`<!---->`);
          }
          _push(`<span class="breadcrumb-path" data-v-bceebdd8>${ssrInterpolate(currentPath.value || "/")}</span></div><!--[-->`);
          ssrRenderList(currentDirectoryItems.value, (item, name) => {
            _push(`<div class="${ssrRenderClass(["directory-item", { "is-directory": isDirectory(item), "is-selected": selectedDirectory.value === name }])}" data-v-bceebdd8>`);
            if (isDirectory(item)) {
              _push(`<span class="icon" data-v-bceebdd8>\u{1F4C1}</span>`);
            } else {
              _push(`<span class="icon" data-v-bceebdd8>\u{1F4C4}</span>`);
            }
            _push(`<span class="name" data-v-bceebdd8>${ssrInterpolate(name)}</span>`);
            if (isDirectory(item)) {
              _push(`<span class="expand-icon" data-v-bceebdd8>\u25B6</span>`);
            } else {
              _push(`<!---->`);
            }
            _push(`</div>`);
        ...
        _push(`</div></div><div class="modal-actions" data-v-bceebdd8><button class="btn-primary"${ssrIncludeBooleanAttr(!selectedDirectory.value) ? " disabled" : ""} data-v-bceebdd8> \uC120\uD0DD </button><button class="btn-secondary" data-v-bceebdd8>\uCDE8\uC18C</button></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
const FileTree = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-bceebdd8"]]);
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  emits: ["file-select", "file-open", "directory-create", "directory-rename", "directory-delete", "file-move", "file-upload"],
  setup(__props, { emit: __emit }) {
    const emit = __emit;
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(FileTree, {
        tree: _ctx.tree,
        "base-path": "",
        "selected-file": _ctx.selectedFile || void 0,
        "show-hidden-files": _ctx.showHiddenFiles,
        "enable-upload": _ctx.enableUpload,
        "upload-path": _ctx.uploadPath,
        ...
        onFileUpload: (d) => emit("file-upload", d)
      }, null, _parent));
      _push(`</div>`);
    };
  }
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.mode === "tree") {
        _push(`<!--[--><div class="flex items-center justify-between"><div></div><div class="flex items-center gap-2"><button class="${ssrRenderClass([showHiddenFiles.value ? "bg-blue-100 text-blue-700" : "bg-gray-100 text-gray-700", "mb-2 px-2 py-1 text-xs border rounded"])}" title="\uC228\uAE40 \uD30C\uC77C \uD45C\uC2DC/\uC228\uAE40">${ssrInterpolate(showHiddenFiles.value ? "\uC228\uAE40 \uD30C\uC77C \uC228\uAE30\uAE30" : "\uC228\uAE40 \uD30C\uC77C \uBCF4\uAE30")}</button><button class="mb-2 px-2 py-1 text-xs border rounded" title="\uC2AC\uB77C\uC774\uB4DC \uB514\uB809\uD1A0\uB9AC \uC124\uC815">\uC124\uC815</button><button class="mb-2 px-2 py-1 text-xs border rounded">\uAD00\uC2EC \uCE74\uD14C\uACE0\uB9AC</button></div></div><div class="flex-1 min-h-0 overflow-auto">`);
        if (isInitialLoading.value) {
          ...
          _push(ssrRenderComponent(_sfc_main$4, {
            ...
            "show-hidden-files": showHiddenFiles.value,
            "enable-upload": true,
            "upload-path": "",
        ...
        _push(`<!--[--><div class="flex items-center justify-between mb-2"><div></div><div class="flex items-center gap-2"><button class="${ssrRenderClass([showHiddenFiles.value ? "bg-blue-100 text-blue-700" : "bg-gray-100 text-gray-700", "px-2 py-1 text-xs border rounded"])}" title="\uC228\uAE40 \uD30C\uC77C \uD45C\uC2DC/\uC228\uAE40">${ssrInterpolate(showHiddenFiles.value ? "\uC228\uAE40 \uD30C\uC77C \uC228\uAE30\uAE30" : "\uC228\uAE40 \uD30C\uC77C \uBCF4\uAE30")}</button><button class="px-2 py-1 text-xs border rounded" title="\uC2AC\uB77C\uC774\uB4DC \uB514\uB809\uD1A0\uB9AC \uC124\uC815">\uC124\uC815</button><button class="px-2 py-1 text-xs border rounded">\uAD00\uC2EC \uCE74\uD14C\uACE0\uB9AC</button></div></div>`);
...
//# sourceMappingURL=KnowledgeBaseExplorer-SrNbTpJE.mjs.map
