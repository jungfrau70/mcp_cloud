import { _ as __nuxt_component_0$1 } from './nuxt-link-csAdjtGj.mjs';
import { defineComponent, shallowRef, getCurrentInstance, provide, cloneVNode, h, createElementBlock, ref, computed, watch, mergeProps, withCtx, createTextVNode, unref, toDisplayString, toRef, isRef, withDirectives, createVNode, createBlock, createCommentVNode, vModelText, openBlock, Fragment, renderList, defineAsyncComponent, watchEffect, nextTick, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderStyle, ssrRenderAttr, ssrRenderClass, ssrIncludeBooleanAttr, ssrRenderSlot, ssrRenderList, ssrLooseContain, ssrLooseEqual } from 'vue/server-renderer';
import { useRoute, useRouter } from 'vue-router';
import { u as useRuntimeConfig, a as useNuxtApp } from './server.mjs';
import { u as useToastStore, _ as _sfc_main$b, a as useKbApi, b as _sfc_main$4$1, r as resolveApiBase } from './KnowledgeBaseExplorer-C5yiN_9k.mjs';
import { _ as _sfc_main$c, e as embed } from './ContentView-DgwCPKiU.mjs';
  ...
  setup(__props, { emit: __emit }) {
    ...
    async function loadcurriculumTreeIfCurriculum() {
      ...
      try {
        ...
        const p = String((route == null ? void 0 : route.path) || "");
...
const SplitEditor = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-ba6e7bda"]]);
const _sfc_main$5 = {
  ...
  setup(__props) {
    ...
    const props = __props;
    const activeComponent = shallowRef(_sfc_main$c);
    computed(() => {
      if (activeComponent.value === _sfc_main$c) {
        return {
    ...
    watch(() => props.activeContent, (newContent) => {
      if (newContent) {
        activeComponent.value = _sfc_main$c;
      }
    });
    return (_ctx, _push, _parent, _attrs) => {
  ...
  setup(__props) {
    ...
    const handleFileClick = async (path) => {
      ...
      try {
        ...
        const msg = String((error2 == null ? void 0 : error2.message) || "");
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<a href="/knowledge-base" class="text-gray-700 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-medium"> \uC9C0\uC2DD\uBCA0\uC774\uC2A4 </a>`);
      if (unref(user)) {
        ...
        _push(`<a href="https://auth.gostock.us/api/logout" class="text-gray-700 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-medium"> \uB85C\uADF8\uC544\uC6C3 </a></div>`);
      } else {
        _push(`<div><button class="px-3 py-2 rounded-md text-sm font-medium text-gray-400 opacity-60 cursor-not-allowed" disabled title="\uB85C\uADF8\uC778 \uC900\uBE44 \uC911"> \uB85C\uADF8\uC778 </button></div>`);
      }
      ...
      if (!isKnowledgeBase.value) {
        ...
        _push(ssrRenderComponent(_sfc_main$a, { onFileClick: handleFileClick }, null, _parent));
        _push(`</div></aside>`);
      } else {
        _push(`<!---->`);
      }
...
//# sourceMappingURL=default-B9pEhgPC.mjs.map
