...
import { u as useToastStore, _ as _sfc_main$9, a as useKbApi, b as _sfc_main$4$1, r as resolveApiBase } from './KnowledgeBaseExplorer-DD-e5jhw.mjs';
...
const _sfc_main$4 = {
  ...
  setup(__props) {
    defineAsyncComponent(() => import('./TipTapKbEditor.client-C86VPO5b.mjs'));
    const props = __props;
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const displayName = computed(() => {
      var _a2, _b;
      const nm = (((_a2 = user.value) == null ? void 0 : _a2.full_name) || "").trim();
      return nm ? nm : ((_b = user.value) == null ? void 0 : _b.email) || "\uC0AC\uC6A9\uC790";
    });
    const isAdmin = computed(() => {
      var _a2;
      const r = String(((_a2 = user.value) == null ? void 0 : _a2.role) || auth.role || "").toLowerCase();
      return r === "admin" || r === "administrator";
    });
    const isTutor = computed(() => {
      var _a2;
      return String(((_a2 = user.value) == null ? void 0 : _a2.role) || auth.role || "").toLowerCase() === "tutor";
    });
...
//# sourceMappingURL=default-BxASau8t.mjs.map
