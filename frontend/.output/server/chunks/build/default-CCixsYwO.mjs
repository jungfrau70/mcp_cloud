...
import { u as useToastStore, _ as _sfc_main$9, a as useKbApi, b as _sfc_main$4$1, r as resolveApiBase } from './KnowledgeBaseExplorer-SrNbTpJE.mjs';
import { _ as _sfc_main$a, e as embed } from './ContentView-BowNUhFE.mjs';
...
const _sfc_main$8 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const apiBase = ((_a = config.public) == null ? void 0 : _a.apiBaseUrl) || "/api";
    const apiKey = ((_b = useRuntimeConfig().public) == null ? void 0 : _b.apiKey) || "my_mcp_eagle_tiger";
    ...
    try {
      (_c = auth.loadFromStorage) == null ? void 0 : _c.call(auth);
    } catch {
    }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "p-4 select-none" }, _attrs))}><div class="flex items-center justify-between mb-4"><h3 class="text-lg font-semibold whitespace-nowrap text-gray-800"> \uCE74\uD14C\uACE0\uB9AC </h3><button class="${ssrRenderClass([showHiddenFiles.value ? "bg-blue-100 text-blue-700" : "bg-gray-100 text-gray-700", "px-2 py-1 text-xs border rounded"])}" title="\uC228\uAE40 \uD30C\uC77C \uD45C\uC2DC/\uC228\uAE40">${ssrInterpolate(showHiddenFiles.value ? "\uC228\uAE40 \uD30C\uC77C \uC228\uAE30\uAE30" : "\uC228\uAE40 \uD30C\uC77C \uBCF4\uAE30")}</button></div>`);
      if (loading.value) {
...
const _sfc_main$4 = {
  ...
  setup(__props) {
    defineAsyncComponent(() => import('./TipTapKbEditor.client-B8piWJH3.mjs'));
    const props = __props;
...
//# sourceMappingURL=default-CCixsYwO.mjs.map
