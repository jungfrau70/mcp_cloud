import { _ as __nuxt_component_0$1 } from './nuxt-link-CzldqjTo.mjs';
import { defineComponent, shallowRef, getCurrentInstance, provide, cloneVNode, h, createElementBlock, ref, computed, watch, mergeProps, withCtx, createTextVNode, unref, toDisplayString, withDirectives, createVNode, createBlock, createCommentVNode, vModelText, openBlock, Fragment, renderList, defineAsyncComponent, watchEffect, nextTick, useSSRContext } from 'vue';
...
import { u as useToastStore, _ as _sfc_main$b, a as useKbApi, b as _sfc_main$4$1, r as resolveApiBase } from './KnowledgeBaseExplorer-iRRYppV9.mjs';
import { _ as _sfc_main$c, e as embed } from './ContentView-CGD-F7JX.mjs';
...
const _sfc_main$a = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    resolveApiBase2();
    ((_a = useRuntimeConfig().public) == null ? void 0 : _a.apiKey) || "my_mcp_eagle_tiger";
    const topics = ref([]);
    const search = ref("");
...
//# sourceMappingURL=default-NLNFFFao.mjs.map
