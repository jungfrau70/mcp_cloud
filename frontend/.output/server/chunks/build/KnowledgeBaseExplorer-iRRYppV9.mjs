...
function useKbApi() {
  ...
  async function getItem(path) {
    return request(`${apiBase}/v1/knowledge-base/item?path=${encodeURIComponent(path)}`, { headers: { "X-API-Key": apiKey } }, "getItem failed");
  }
...
const FileTree = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-08685139"]]);
...
//# sourceMappingURL=KnowledgeBaseExplorer-iRRYppV9.mjs.map
