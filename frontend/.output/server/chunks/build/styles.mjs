...
const styles = {
  "node_modules/nuxt/dist/app/entry.js": () => import('./entry-styles.CU-nrlv9.mjs').then(interopDefault),
  ...
  "components/ContentView.vue": () => import('./ContentView-styles.Ca2jR2mg.mjs').then(interopDefault),
  ...
  "components/ContentView.vue?vue&type=style&index=0&lang.css": () => import('./ContentView-styles.CF9yYpcQ.mjs').then(interopDefault),
  ...
  "components/FileTree.vue": () => import('./FileTree-styles.Jaslcx31.mjs').then(interopDefault),
  "components/FileTree.vue?vue&type=style&index=0&scoped=bceebdd8&lang.css": () => import('./FileTree-styles.CA9_lb9-.mjs').then(interopDefault)
};
