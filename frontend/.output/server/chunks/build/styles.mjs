...
const styles = {
  ...
  "components/ContentView.vue": () => import('./ContentView-styles.D-iOhz1j.mjs').then(interopDefault),
  ...
  "components/FileTree.vue": () => import('./FileTree-styles.ryJX13VC.mjs').then(interopDefault),
  "components/FileTree.vue?vue&type=style&index=0&scoped=5b0bbf51&lang.css": () => import('./FileTree-styles.Bk4sSYfy.mjs').then(interopDefault)
};
