import { _ as __nuxt_component_0$1 } from './nuxt-link-DynZTYcZ.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(user)) {
        ...
        _push(`<button class="text-gray-700 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-medium">\uB85C\uADF8\uC544\uC6C3</button></div>`);
      } else {
        _push(`<div class="flex items-center space-x-2">`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: "/login",
...
//# sourceMappingURL=default-CqHWfo7r.mjs.map
