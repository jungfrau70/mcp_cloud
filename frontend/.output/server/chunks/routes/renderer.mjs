...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"AI 기반 멀티클라우드 관리 플랫폼"}],"link":[],"style":[],"script":[],"noscript":[],"title":"Bigs"};
