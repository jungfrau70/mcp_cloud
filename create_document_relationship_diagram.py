...
"""
    ...
    with open("document_relationship_diagram.md", "w", encoding="utf-8") as f:
        f.write(diagram)
    
    print("📊 문서 관계 다이어그램 생성: document_relationship_diagram.md")

def main():
    """메인 함수"""
    print("🚀 문서 관계 시각화 다이어그램 생성")
