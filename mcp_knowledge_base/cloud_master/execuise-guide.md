...
3. [실습 진행 방법](#3-실습-진행-방법)
   - [Day 1: VM 배포 및 기본 실습](#31-day-1-vm-배포-및-기본-실습)
   - [Day 2: Kubernetes 및 컨테이너 오케스트레이션](#32-day-2-kubernetes-및-컨테이너-오케스트레이션)
   - [Day 3: 모니터링, 로드밸런싱, 비용 최적화](#33-day-3-모니터링-로드밸런싱-비용-최적화)
