...
## 📋 목차
1. [컨테이너 오케스트레이션 개념](#컨테이너-오케스트레이션-개념)
2. [AWS ECS vs GCP GKE 비교](#aws-ecs-vs-gcp-gke-비교)
3. [AWS ECS 아키텍처](#aws-ecs-아키텍처)
4. [GCP GKE 아키텍처](#gcp-gke-아키텍처)
5. [실습 목표](#실습-목표)
6. [실습 절차](#실습-절차)
7. [실습 코드 예시](#실습-코드-예시)
8. [예상 결과](#예상-결과)
...
다음 단계: [4교시: 전체 자동 배포 파이프라인 구성](../Day1/cicd-pipeline-guide.md)
