...
[📋 목차](#-)
1. [클라우드 비용 구조 이해](#-)
2. [AWS vs GCP 과금 모델 비교](#-aws-vs-gcp)
3. [프리 티어 및 할인 옵션](#-)
4. [비용 계산기 활용](#-)
5. [실습 목표](#-)
6. [실습 절차](#-)
...
[1. **종량제(Pay-as-you-go)**](#-1.-**(pay-as-you-go)**)**)
- 사용한 서비스에 대해서만 과금
...
[2. **계층형 요금(Tiered Pricing)**](#-2.-**-(tiered-pricing)**)**)
...
[2. **Always Free 서비스**](#-2.-**always-free-**)
| 서비스 | 무료 한도 | 기간 |
|--------|-----------|------|
...
[1단계: 비용 계산기 접속 및 기본 설정](#-1:)

#### AWS Pricing Calculator 접속

[AWS Pricing Calculator 접속](#-aws-pricing-calculator)
```bash
...
[Google Cloud Pricing Calculator 접속](#-google-cloud-pricing-calculator)
```bash
