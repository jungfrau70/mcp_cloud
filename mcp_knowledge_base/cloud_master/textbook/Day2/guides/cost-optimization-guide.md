...
다음 단계: [3교시: CloudWatch / Cloud Monitoring을 활용한 서비스 모니터링](/mcp_knowledge_base/cloud_master/textbook/Day2/guides/monitoring-guide.md)
...
[← 이전: Cloud Master 2일차 메인](/mcp_knowledge_base/README.md) | [📚 전체 커리큘럼](/mcp_knowledge_base/curriculum.md) | [🏠 학습 경로로 돌아가기](/mcp_knowledge_base/index.md) | [📋 학습 경로](/mcp_knowledge_base/learning-path.md) | [다음: 모니터링 가이드 →](/mcp_knowledge_base/cloud_master/textbook/Day2/guides/monitoring-guide.md)
