...
[1단계: AWS Cost Explorer 활성화 및 설정](#-1:-aws-cost-explorer)

#### Cost Explorer 활성화

[Cost Explorer 활성화](#-cost-explorer)
```bash
...
[2단계: AWS Budgets 설정](#-2:-aws-budgets)
...
[3단계: AWS Trusted Advisor 권장사항 확인](#-3:-aws-trusted-advisor)
...
[4단계: GCP 비용 관리 도구 설정](#-4:-gcp)

#### Cloud Billing Reports 설정

[Cloud Billing Reports 설정](#-cloud-billing-reports)
```bash
# 프로젝트별 비용 조회
...
[5단계: GCP Cloud Recommender 활용](#-5:-gcp-cloud-recommender)
