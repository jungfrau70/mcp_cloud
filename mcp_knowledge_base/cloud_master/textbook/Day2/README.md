...
## 📖 현재 위치
**Cloud Master** > **2일차** > **Cloud Master - 2일차: 고급 CI/CD 및 VM 기반 컨테이너 배포**

## ⬅️ 이전/다음 네비게이션
[← 이전: Cloud Master 1일차 →](/mcp_knowledge_base/cloud_master/textbook/Day1/README.md) | [다음: Cloud Master 3일차 →](/mcp_knowledge_base/cloud_master/textbook/Day3/README.md)
...
## 📚 이론 학습
1. [🎯 학습 목표](#학습-목표)
2. [🐳 Docker 고급 기법 및 최적화 이론](#docker-고급-기법-및-최적화-이론)
3. [🚀 GitHub Actions 고급 워크플로우 이론](#github-actions-고급-워크플로우-이론)
4. [🚀 Kubernetes 기초 및 클러스터 관리 이론](#kubernetes-기초-및-클러스터-관리-이론)
5. [🚀 VM 기반 컨테이너 배포 자동화 이론](#vm-기반-컨테이너-배포-자동화-이론)
6. [🔄 완전 자동화된 배포 파이프라인 이론](#완전-자동화된-배포-파이프라인-이론)

## 🛠️ 실습 학습
7. [🔧 실습 환경 준비](#실습-환경-준비)
8. [📚 학습 자료](#학습-자료)
9. [🚀 시작하기](#시작하기)
10. [🐳 Docker 고급 기법 및 최적화 실습](#docker-고급-기법-및-최적화-실습)
11. [🚀 GitHub Actions 고급 워크플로우 실습](#github-actions-고급-워크플로우-실습)
12. [🚀 Kubernetes 기초 및 클러스터 관리 실습](#kubernetes-기초-및-클러스터-관리-실습)
13. [🚀 VM 기반 컨테이너 배포 자동화 실습](#vm-기반-컨테이너-배포-자동화-실습)
14. [🔄 완전 자동화된 배포 파이프라인 실습](#완전-자동화된-배포-파이프라인-실습)
