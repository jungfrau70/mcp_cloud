...
### 문제 2: Service가 외부에 노출되지 않음

#### 증상
- Service가 ClusterIP로만 설정됨
- 외부에서 접근할 수 없음
...
# 리소스 요청 확인
kubectl get deployment DEPLOYMENT_NAME -o yaml | grep -A 10 resources
