...
[📝 실습 1: Git 기본 명령어](#-1:-git)

### 1. 저장소 초기화 및 기본 워크플로우

[1. 저장소 초기화 및 기본 워크플로우](#-1.)
```bash
# 새 디렉토리 생성
mkdir git-practice
cd git-practice
...
[📝 실습 3: GitHub 협업](#-3:-github)

### 1. GitHub 저장소 생성 및 연결

[1. GitHub 저장소 생성 및 연결](#-1.-github)
```bash
# GitHub에서 새 저장소 생성 후
# 원격 저장소 추가
...
[📝 실습 4: Pull Request 워크플로우](#-4:-pull-request)

### 1. Feature 브랜치에서 작업

[1. Feature 브랜치에서 작업](#-1.-feature)
```bash
# 새 feature 브랜치 생성
...
[2. GitHub에서 Pull Request 생성](#-2.-github-pull-request)
