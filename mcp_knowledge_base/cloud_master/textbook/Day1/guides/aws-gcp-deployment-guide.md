...
[GCP Cloud Run 배포](#-gcp-cloud-run)

#### 1. GCP Cloud Run이란?

[1. GCP Cloud Run이란?](#-1.-gcp-cloud-run?)
...
[2. GCP Cloud Run 배포 장점](#-2.-gcp-cloud-run)
- **서버리스**: 인프라 관리 불필요
...
[3. GCP Cloud Run 배포 흐름](#-3.-gcp-cloud-run)
```mermaid
graph LR
