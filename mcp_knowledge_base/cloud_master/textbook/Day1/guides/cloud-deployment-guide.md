...
1. [🎯 학습 목표](#-)
2. [📦 actions-demo 프로젝트 소개](#-actions-demo)
3. [🚀 실습 환경 준비](#-)
4. [⚖️ 가상머신 배포 실습](#-)
5. [🔧 GitHub Actions 워크플로우 설정](#-github-actions)
6. [📚 문제 해결 및 참고 자료](#-)
...
[Node.js Express 애플리케이션](#-node.js-express)
- **프레임워크**: Express.js
- **포트**: 3000 (기본)
...
[2단계: GitHub Secrets 설정](#-2:-github-secrets)
...
[🚀 GitHub Actions를 통한 자동 배포](#-github-actions)
...
[GitHub Actions 관련 문제](#-github-actions)
