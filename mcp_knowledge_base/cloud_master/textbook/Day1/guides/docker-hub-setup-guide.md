...
[📋 목차](#-)
1. [🐳 Docker Hub란?](#-docker-hub?)
2. [📝 Docker Hub 가입하기](#-docker-hub)
3. [Personal Access Token 생성하기](#-personal-access-token)
4. [🔐 GitHub 시크릿 설정하기](#-github)
5. [✅ 설정 확인하기](#-)
6. [🐛 문제 해결](#-)
...
[1단계: Docker Hub 웹사이트 접속](#-1:-docker-hub)
...
[1단계: GitHub 저장소 접속](#-1:-github)
1. GitHub에서 `actions-demo` 저장소 접속
2. 상단 메뉴에서 **"Settings"** 클릭

### 2단계: Secrets and variables 메뉴 접속

[2단계: Secrets and variables 메뉴 접속](#-2:-secrets-and-variables)
...
[3단계: GitHub Actions 실행 확인](#-3:-github-actions)
...
[4단계: Docker Hub에서 이미지 확인](#-4:-docker-hub)
...
[1. Docker Hub 로그인 실패](#-1.-docker-hub)
```
