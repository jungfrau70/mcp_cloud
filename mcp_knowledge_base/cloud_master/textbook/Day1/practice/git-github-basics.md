...
[← 이전: Docker 기초 실습](/mcp_knowledge_base/cloud_master/textbook/Day1/practice/docker-basics.md) | [📚 전체 커리큘럼](/mcp_knowledge_base/curriculum.md) | [🏠 학습 경로로 돌아가기](/mcp_knowledge_base/index.md) | [다음: GitHub Actions 기초 실습 →](/mcp_knowledge_base/cloud_master/textbook/Day1/practice/github-actions-basics.md) | [← 이전: Cloud Master 메인](/mcp_knowledge_base/cloud_master/README.md) | [📋 학습 경로](/mcp_knowledge_base/cloud_master/learning-path.md)
...
[📝 실습 1: Git 기본 명령어](#실습-1-git-기본-명령어)

### 1. 저장소 초기화 및 기본 워크플로우

[1. 저장소 초기화 및 기본 워크플로우](#1-저장소-초기화-및-기본-워크플로우)
```bash
# 새 디렉토리 생성
mkdir git-practice
cd git-practice
...
[📝 실습 2: 브랜치 관리](#실습-2-브랜치-관리)

### 1. 브랜치 생성 및 전환

[1. 브랜치 생성 및 전환](#1-브랜치-생성-및-전환)
```bash
# 현재 브랜치 확인
git branch
...
[📝 실습 3: GitHub 협업](#실습-3-github-협업)

### 1. GitHub 저장소 생성 및 연결

[1. GitHub 저장소 생성 및 연결](#1-github-저장소-생성-및-연결)
```bash
# GitHub에서 새 저장소 생성 후
# 원격 저장소 추가
...
[📝 실습 4: Pull Request 워크플로우](#실습-4-pull-request-워크플로우)

### 1. Feature 브랜치에서 작업

[1. Feature 브랜치에서 작업](#1-feature-브랜치에서-작업)
```bash
# 새 feature 브랜치 생성
...
[2. GitHub에서 Pull Request 생성](#2-github에서-pull-request-생성)
...
[📝 실습 5: 충돌 해결](#실습-5-충돌-해결)

### 1. 충돌 상황 만들기

[1. 충돌 상황 만들기](#1-충돌-상황-만들기)
```bash
# main 브랜치에서 파일 수정
...
[📝 실습 7: 협업 시나리오](#실습-7-협업-시나리오)

### 1. 팀 프로젝트 시뮬레이션

[1. 팀 프로젝트 시뮬레이션](#1-팀-프로젝트-시뮬레이션)
```bash
# 프로젝트 디렉토리 생성
mkdir team-project
cd team-project
