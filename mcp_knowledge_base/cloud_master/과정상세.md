...
> **다음 과정**: [Cloud Container 과정](/mcp_knowledge_base/README.md) | [전체 커리큘럼](/mcp_knowledge_base/curriculum.md) | [🏠 학습 경로로 돌아가기](/mcp_knowledge_base/index.md)
...
> 📚 **상세 실습 가이드**: [Day1 실습 가이드](/mcp_knowledge_base/README.md)
...
> 📚 **상세 실습 가이드**: [Day2 실습 가이드](/mcp_knowledge_base/README.md)
...
> 📚 **상세 실습 가이드**: [Day3 실습 가이드](/mcp_knowledge_base/README.md)

</details>

<details>
<summary>📌 수강 대상</summary>

* **Cloud Basic 과정을 수료한 학습자** (필수)
* DevOps, 인프라 운영 및 최적화를 담당하는 IT 전문가
* AWS/GCP 환경에서 **실무 통합 역량**을 강화하려는 아키텍트 및 엔지니어

> **관련 과정**: [Cloud Basic 과정](/mcp_knowledge_base/README.md) | [Cloud Container 과정](/mcp_knowledge_base/README.md) | [전체 커리큘럼](/mcp_knowledge_base/curriculum.md)

</details>

<details>
<summary>📌 선수 요구사항</summary>
...
> 📚 **기초 과정**: [Cloud Basic 과정](/mcp_knowledge_base/README.md)에서 AWS/GCP 기초 서비스를 먼저 학습하세요.

</details>
<details>
<summary>📌 학습 성과 (Learning Outcomes)</summary>
