...
> **관련 과정**: [Cloud Master 과정](/mcp_knowledge_base/README.md) | [전체 커리큘럼](/mcp_knowledge_base/curriculum.md)
...
> 📚 **기초 과정**: [Cloud Master 과정](/mcp_knowledge_base/README.md)에서 Docker, CI/CD, 컨테이너 배포를 먼저 학습하세요.
