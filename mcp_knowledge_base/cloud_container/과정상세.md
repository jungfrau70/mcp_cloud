...
## 📖 현재 위치
**Cloud Container** > **1일차** > **클라우드 실무력 강화! AWS & GCP 활용법(컨테이너 심화)**
...
> 📚 **상세 실습 가이드**: [Day1 실습 가이드](/mcp_knowledge_base/cloud_container/textbook/Day1/README.md)
...
> 📚 **상세 실습 가이드**: [Day2 실습 가이드](/mcp_knowledge_base/cloud_container/textbook/Day2/README.md)
...
> 📚 **기초 과정**: [Cloud Master 과정](/mcp_knowledge_base/cloud_master/textbook/Day1/README.md)에서 Docker, CI/CD, 컨테이너 배포를 먼저 학습하세요.
