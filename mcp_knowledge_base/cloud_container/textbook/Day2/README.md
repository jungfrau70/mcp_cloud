...
## 📚 이론 학습
1. [🎯 학습 목표](#학습-목표)
2. [🚀 고가용성 아키텍처 설계 이론](#고가용성-아키텍처-설계-이론)
3. [🚀 로드 밸런싱 및 Auto Scaling 이론](#로드-밸런싱-및-auto-scaling-이론)
4. [📊 모니터링 및 로깅 시스템 이론](#모니터링-및-로깅-시스템-이론)
5. [🎯 종합 프로젝트 및 최적화 이론](#종합-프로젝트-및-최적화-이론)

## 🛠️ 실습 학습
6. [📚 실습 가이드](#실습-가이드)
7. [🔧 실습 환경 준비](#실습-환경-준비)
8. [🚀 고가용성 아키텍처 설계 실습](#고가용성-아키텍처-설계-실습)
9. [🚀 로드 밸런싱 및 Auto Scaling 실습](#로드-밸런싱-및-auto-scaling-실습)
10. [📊 모니터링 및 로깅 시스템 실습](#모니터링-및-로깅-시스템-실습)
11. [🎯 종합 프로젝트 및 최적화 실습](#종합-프로젝트-및-최적화-실습)
...
### 📚 개념 학습
- 🔗 [고급 로드 밸런싱 가이드](/mcp_knowledge_base/cloud_container/textbook/Day2/practice/advanced-load-balancing.md)
...
### 📚 개념 학습
- 🔗 [모니터링 시스템 가이드](/mcp_knowledge_base/cloud_container/textbook/Day2/monitoring-setup.md)
...
### 📚 개념 학습
- 🔗 [종합 프로젝트 가이드](/mcp_knowledge_base/cloud_container/textbook/Day2/practice/comprehensive-project.md)
...
### 모니터링 관련 문제
- 🔗 [모니터링 트러블슈팅](/mcp_knowledge_base/cloud_container/textbook/Day2/troubleshooting/multi-az-issues.md)
