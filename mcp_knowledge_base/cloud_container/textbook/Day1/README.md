...
[Kubernetes 핵심 리소스](#kubernetes-핵심-리소스)
...
[ECS (Elastic Container Service)란?](#ecs-elastic-container-service란)
...
[ECS vs Kubernetes 비교](#ecs-vs-kubernetes-비교)
| 특징 | ECS | Kubernetes |
|------|-----|------------|
| **관리 복잡도** | 낮음 | 높음 |
| **유연성** | 중간 | 높음 |
...
[고급 CI/CD 파이프라인 단계](#고급-cicd-파이프라인-단계)
...
[Kubernetes의 설계 철학](#kubernetes의-설계-철학)
...
[컨테이너 오케스트레이션의 필요성](#컨테이너-오케스트레이션의-필요성)
...
[Kubernetes의 핵심 개념](#kubernetes의-핵심-개념)
