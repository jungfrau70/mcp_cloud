...
## 📖 현재 위치
**Cloud Container** > **1일차** > **GCP 계정 유형 비교 가이드**
...
### 개인 계정 사용자
- [GCP 개인 계정 가입 가이드](/mcp_knowledge_base/cloud_container/accounts/GCP_개인계정가입.md) 참조
- **Always Free** 서비스 활용
- **개인 프로젝트** 포트폴리오 구축

### 조직 계정 사용자
- [GCP 조직 계정 가입 가이드](/mcp_knowledge_base/cloud_container/accounts/GCP_조직계정가입.md) 참조
- **조직 정책** 설정
- **팀 협업** 워크플로 구축
