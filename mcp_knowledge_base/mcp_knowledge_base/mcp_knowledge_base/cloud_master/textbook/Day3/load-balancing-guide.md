...
1. [📚 실습 가이드](#실습-가이드)
2. [🔧 실습 환경 준비](#실습-환경-준비)
3. [🚀 로드 밸런싱 및 Auto Scaling 실습](#로드-밸런싱-및-auto-scaling-이론)
...
- **⚖️ 로드 밸런싱**: ELB, Cloud Load Balancing 구성
- **📈 Auto Scaling**: 자동 확장 및 축소 정책
- **📊 모니터링**: CloudWatch, Cloud Monitoring 설정
- **🔄 장애 복구**: Health Check 기반 자동 복구
...
- [Cloud Container 과정](mcp_knowledge_base/cloud_master/README.md)
