...
- ["클라우드 컴퓨팅 개념"](cloud_basic/textbook/Day1/aws-gcp-account-setup.md)
- ["AWS 서비스 개요"](cloud_basic/textbook/Day1/aws-gcp-account-setup.md)
- ["GCP 서비스 개요"](cloud_basic/textbook/Day1/aws-gcp-account-setup.md)

#### 2단계: AWS 계정 생성 및 설정 ["1시간"]

- ["AWS 계정 생성"]["cloud_basic/accounts/AWS계정가입.md"]
- ["AWS CLI 설치 및 설정"](cloud_basic/textbook/Day1/guides/install_aws_cli.md)
- ["기본 보안 설정"](cloud_basic/textbook/Day1/iam-basics-guide.md)

#### 3단계: GCP 계정 생성 및 설정 ["1시간"]

- ["GCP 계정 생성"]["cloud_basic/accounts/GCP_개인계정가입.md"]
- ["GCP CLI 설치 및 설정"](cloud_basic/textbook/Day1/guides/install_glcoud_cli.md)
- ["프로젝트 설정"](cloud_basic/textbook/Day1/aws-gcp-account-setup.md)

#### 4단계: 기본 실습 환경 확인 ["1시간"]

- ["환경 설정 확인"](cloud_basic/textbook/Day1/aws-gcp-account-setup.md)
- ["연결 테스트"](cloud_basic/textbook/Day1/aws-gcp-account-setup.md)
...
- ["EC2 인스턴스 생성"](cloud_basic/textbook/Day1/vm-services-guide.md)
- ["SSH 연결"](cloud_basic/textbook/Day1/vm-services-guide.md)
- ["기본 명령어 실행"](cloud_basic/textbook/Day1/vm-services-guide.md)

#### 6단계: AWS S3 실습 ["1시간"]

- ["S3 버킷 생성"](cloud_basic/textbook/Day1/storage-services-guide.md)
- ["파일 업로드/다운로드"](cloud_basic/textbook/Day1/storage-services-guide.md)
- ["권한 설정"](cloud_basic/textbook/Day1/storage-services-guide.md)

#### 7단계: GCP Compute Engine 실습 ["1시간"]

- ["Compute Engine 인스턴스 생성"](cloud_basic/textbook/Day1/vm-services-guide.md)
- ["SSH 연결"](cloud_basic/textbook/Day1/vm-services-guide.md)
- ["기본 명령어 실행"](cloud_basic/textbook/Day1/vm-services-guide.md)

#### 8단계: GCP Cloud Storage 실습 ["1시간"]

- ["Cloud Storage 버킷 생성"](cloud_basic/textbook/Day1/storage-services-guide.md)
- ["파일 업로드/다운로드"](cloud_basic/textbook/Day1/storage-services-guide.md)
- ["권한 설정"](cloud_basic/textbook/Day1/storage-services-guide.md)
...
["🚀 실습 시작하기"](cloud_basic/textbook/Day1/aws-gcp-account-setup.md) | 
📚 Cloud Basic 과정 전체 |
["🏠 홈으로 돌아가기"](index.md)
