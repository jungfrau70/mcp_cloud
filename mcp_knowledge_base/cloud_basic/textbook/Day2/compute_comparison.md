...
[가상 머신 서비스 비교](#가상-머신-서비스-비교)

### AWS EC2 vs GCP Compute Engine

[AWS EC2 vs GCP Compute Engine](#aws-ec2-vs-gcp-compute-engine)
...
[GCP Compute Engine 상세 분석](#gcp-compute-engine-상세-분석)

### Compute Engine의 강점

[Compute Engine의 강점](#compute-engine의-강점)
...
[Compute Engine의 약점](#compute-engine의-약점)
...
[Compute Engine 사용 사례](#compute-engine-사용-사례)
- **Google 서비스와의 통합**
- **컨테이너 기반 워크로드**
- **데이터 분석 및 머신러닝**
- **비용 효율적인 개발 환경**
...
[서버리스 컴퓨팅 비교](#서버리스-컴퓨팅-비교)

### AWS Lambda vs GCP Cloud Functions

[AWS Lambda vs GCP Cloud Functions](#aws-lambda-vs-gcp-cloud-functions)
...
[AWS Lambda 상세 분석](#aws-lambda-상세-분석)

### Lambda의 강점

[Lambda의 강점](#lambda의-강점)
...
[GCP Cloud Functions 상세 분석](#gcp-cloud-functions-상세-분석)

### Cloud Functions의 강점

[Cloud Functions의 강점](#cloud-functions의-강점)
...
[Cloud Functions의 약점](#cloud-functions의-약점)
...
[Cloud Functions 사용 사례](#cloud-functions-사용-사례)
- **Google 서비스 연동**
- **웹훅 처리**
- **데이터 파이프라인**
- **이벤트 기반 처리**
...
[서버리스 성능 비교](#서버리스-성능-비교)

### Cold Start 성능

[Cold Start 성능](#cold-start-성능)
```
...
[AWS에서 GCP로 마이그레이션](#aws에서-gcp로-마이그레이션)

#### 1. 단계별 접근 (Infographic)

[1. 단계별 접근 (Infographic)](#1-단계별-접근-infographic)
...
[2. GCP Compute Engine](#2-gcp-compute-engine)
...
[2. GCP Cloud Functions](#2-gcp-cloud-functions)
