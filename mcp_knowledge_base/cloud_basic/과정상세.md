...
## 📖 현재 위치
**Cloud Basic** > **1일차** > **클라우드 실무력 강화! AWS & GCP 활용법(기초)**
...
> 📚 **상세 실습 가이드**: [Day1 실습 가이드](/mcp_knowledge_base/cloud_basic/textbook/Day1/README.md)
...
> 📚 **상세 실습 가이드**: [Day2 실습 가이드](/mcp_knowledge_base/cloud_basic/textbook/Day2/README.md)
