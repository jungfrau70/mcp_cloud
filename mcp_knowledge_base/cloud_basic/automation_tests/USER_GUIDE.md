...
## 📖 현재 위치
**Cloud Basic** > **1일차** > **Basic 과정 자동화 - 빠른 시작 가이드**
...
```bash
# Day 1 실습
cd mcp_knowledge_base/cloud_basic/automation/day1
chmod +x *.sh
./cloud_basics.sh
./iam_basics.sh
./vm_services.sh
...
# 생성된 스크립트 확인
ls -la mcp_knowledge_base/cloud_basic/automation/day1/
ls -la mcp_knowledge_base/cloud_basic/automation/day2/
```
