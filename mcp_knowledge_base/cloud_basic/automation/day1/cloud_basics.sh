...
echo -e "\n${BLUE}교재 참조:${NC}"
echo "- [클라우드 계정 설정 가이드](/mcp_knowledge_base/cloud_basic/textbook/Day1/aws-gcp-account-setup.md)"
echo "- [1일차 실습 가이드](/mcp_knowledge_base/cloud_basic/textbook/Day1/README.md)"
