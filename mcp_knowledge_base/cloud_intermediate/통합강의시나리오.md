...
- **클라우드 컨테이너 서비스**: AWS ECS, GCP Cloud Run을 활용하여 다양한 클라우드 환경에 컨테이너 애플리케이션을 배포하고 운영합니다.
- **VM 기반 배포**: AWS EC2, GCP Compute Engine을 활용하여 VM 기반 애플리케이션을 배포하고 모니터링합니다.
...
## 📚 Day 2: CI/CD 및 VM 기반 배포, 멀티 클라우드 모니터링
...
- [ ] AWS EC2 VM 애플리케이션 모니터링 실습 완료
- [ ] GCP Compute Engine VM 통합 모니터링 실습 완료
- [ ] AWS ECS 고급 배포 실습 완료
