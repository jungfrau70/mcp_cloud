...
**학습 목표**
- GitHub Actions를 통한 AWS EC2 VM 애플리케이션 배포
- VM 기반 애플리케이션 모니터링 설정
- 실시간 애플리케이션 성능 모니터링
...
- EC2 VM 애플리케이션 배포
- VM 기반 애플리케이션 배포 및 모니터링 확인

**학습 결과**
- ✅ GitHub Actions CI/CD 파이프라인 구축
- ✅ AWS EC2 VM 애플리케이션 자동 배포
- ✅ VM 기반 Application 모니터링 설정
- ✅ 실시간 애플리케이션 성능 모니터링

#### **4교시: GCP Compute Engine VM 통합 모니터링 (90분)**
**학습 목표**
- GCP Compute Engine VM 구축 및 멀티 클라우드 통합 모니터링 완성
- GCP VM Infrastructure/Platform 모니터링
- Global Dashboard를 통한 통합 시각화

**실습 내용**
- Phase 4: GCP VM 모니터링
- GCP Compute Engine VM 생성
- GCP VM Infrastructure/Platform 모니터링 설정
- Global Prometheus에 GCP VM 연동

**학습 결과**
- ✅ GCP Compute Engine VM 구축
- ✅ GCP VM Infrastructure/Platform 모니터링
...
```
cloud_intermediate/
├── repo/practice/day1/          # Day1 실습 샘플 코드
...
├── repo/practice/day2/          # Day2 실습 샘플 코드
│   ├── github-actions-demo-day2/     # CI/CD 파이프라인
│   ├── aws-ec2-vm/  # AWS EC2 VM 배포
│   ├── gcp-vm/  # GCP VM 배포
│   └── multi-cloud-vm/ # 멀티 클라우드 VM 통합
├── repo/automation/               # 자동화 스크립트
│   ├── day1/  # Day1 실습 자동화
│   ├── day2/  # Day2 실습 자동화
...
- [학습 경로](cloud_intermediate/learning-path.md) - 전체 학습 경로
