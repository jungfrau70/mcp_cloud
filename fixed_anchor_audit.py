...
def extract_anchors_from_markdown(content):
    ...
    for line in content.split('\n'):
        ...
        if match:
            ...
            anchor_id = normalize_anchor_id(heading_text)
...
def main():
    parser = argparse.ArgumentParser(description='수정된 앵커 링크 전수 조사 도구')
